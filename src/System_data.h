...
public:
  ...
  inline void push_back(vector<REAL> *to_add)
  {
    this->data.push_back(to_add);
  }
  ...
  inline void target(REAL target_value)
  {
    my_target.push_back(target_value);
  }
  ...
  inline void lock(bool new_is_locked=true)
  {

...
public:
  ...
  inline vector<complex<REAL> > dOutput_dParameters()
  {
    return my_dOutput_dParameters;
  }
  inline complex<REAL> dOutput_dParameters(int i)
  {
    return my_dOutput_dParameters[i];
  }

  inline vector<complex<REAL> > dOutput_dInputs()
  {
    return my_dOutput_dInputs;
  }
  inline complex<REAL> dOutput_dInputs(int i)
  {
